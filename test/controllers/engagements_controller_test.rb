...
class EngagementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create engagement" do
    assert_difference("Engagement.count") do
      post engagements_url, params: { engagement: { description: @engagement.description, end_time: @engagement.end_time, start_time: @engagement.start_time, title: @engagement.title } }
    end
  ...
  test "should update engagement" do
    patch engagement_url(@engagement), params: { engagement: { description: @engagement.description, end_time: @engagement.end_time, start_time: @engagement.start_time, title: @engagement.title } }
